...
define('COURIER2_TXT_COST', 'Shipping charge applicable if order weight is lower than specified. You may input whether a fixed charge or a percent of order amount. E.g. "10" will indicate that shipping rate is 10 (conventional units), and "10%" will calculate shipping charge as 10% of order amount');
?>